...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView tvSelected = findViewById(R.id.tvSelected);

        LuckyItem luckyItem1 = new LuckyItem();
        luckyItem1.topText = "10%";
//        luckyItem1.icon = R.drawable.test1;
        luckyItem1.color = Color.parseColor("#f72924");
        data.add(luckyItem1);

        LuckyItem luckyItem2 = new LuckyItem();
        luckyItem2.topText = "20%";
//        luckyItem2.icon = R.drawable.test2;
        luckyItem2.color = Color.parseColor("#180636");
        data.add(luckyItem2);

        LuckyItem luckyItem3 = new LuckyItem();
        luckyItem3.topText = "40%";
//        luckyItem3.icon = R.drawable.test3;
        luckyItem3.color = Color.parseColor("#f72924");
        data.add(luckyItem3);

        //////////////////
        LuckyItem luckyItem4 = new LuckyItem();
        luckyItem4.topText = "60%";
//        luckyItem4.icon = R.drawable.test4;
        luckyItem4.color = Color.parseColor("#ffd101");
        data.add(luckyItem4);

        LuckyItem luckyItem5 = new LuckyItem();
        luckyItem5.topText = "100%";
//        luckyItem5.icon = R.drawable.test6;
        luckyItem5.color = Color.parseColor("#57060d");
        data.add(luckyItem5);

        LuckyItem luckyItem6 = new LuckyItem();
        luckyItem6.topText = "80%";
//        luckyItem6.icon = R.drawable.test5;
        luckyItem6.color = Color.parseColor("#ffd101");
        data.add(luckyItem6);
        ...
        luckyWheelView.setLuckyRoundItemSelectedListener(new LuckyWheelView.LuckyRoundItemSelectedListener() {
            ...
            public void LuckyRoundItemSelected(int index) {
                String txt = "Selected : " + data.get(index).topText;
